export const projects = [
  {
    title: 'E-Commerce',
     description:"A modern E-Commerce website with Stripe payment options, ability to add and remove items from the sites, edit prices and many other features. ",
  ...
  {
    title: 'Portfolio',
    description: "A portfolio about myself.",
...
export const TimeLineData = [
  ...
  { year: 2020, text: 'Did internship', },
  { year: 2021, text: 'Worked with different Startups', }
];